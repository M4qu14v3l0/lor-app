  ...
  return (
    <div className="h-[100vh]">
      <BackgroundImage src="/bg/ruin-castle.webp" alt="ruin castle wallpaper" style=" flex justify-center items-center" >
        <p className="z-10 absolute top-[20%] left-[0%] mx-5  sm:top-[40%] sm:left-[50%] bg-[#1e1e1e] p-5 text-xl rounded-xl">{firstQuote[0].dialog}</p>
        <p className="z-10 absolute top-[65%] right-[0%] mx-5   sm:top-[60%] sm:right-[30%] bg-[#1e1e1e] p-5 text-xl rounded-xl">{secondQuote[0].dialog}</p>
        <Gollum />
      </BackgroundImage>
    </div>
  );
