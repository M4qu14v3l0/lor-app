...
export const BentoGrid = () => {
  ...
  return (
    <div className="w-full max-w-[1400px] grid grid-cols-10 auto-rows-[25rem] gap-4 mx-auto p-20">
      {
