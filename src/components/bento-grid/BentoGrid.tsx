import { BentoItem } from "./BentoItem"
  ...
  const bentoGridInfo = [
    {background:"/bg/bg-gandalf.webp" ,backgroundAlt:"gandalf wallpaper", styles:'col-span-10 lg:col-span-4', title:'The lord of rings', description: '"The Lord of the Rings" is an iconic literary saga created by J.R.R. Tolkien, immersing readers into a world of epic fantasy filled with memorable characters, thrilling adventures, and an epic conflict between good and evil.'},
